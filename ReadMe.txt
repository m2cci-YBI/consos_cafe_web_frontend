...
Les donnees de la bd couvrent uniquement les semaines 25 , 26 , 27
...
Pour la resoudre il faut specifier dans le backend les domaines autorisée a recevoir les data, autoriser les differents methodes get post put delete options , et autoriser les headers.

On a donc defini une classe de configuration dans la parti backend qui autorise cela.

Si vous vous connectez a la parti back end depuis postman ou insomnia vous n'aurai pas ce probleme car la verification CORS est fait juste par les browsers.